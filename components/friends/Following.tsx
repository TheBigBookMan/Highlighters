...
const Following = () => {
  ...
  // * Update user database by adding new follower
  ...
  // * Update user database by removing follower
  ...
  // * Update logged in user database by adding new user follow
  ...
  // * Update logged in user database by removed user follow
